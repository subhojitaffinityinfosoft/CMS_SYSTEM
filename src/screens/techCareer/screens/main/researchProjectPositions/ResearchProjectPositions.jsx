...
import { AREA, CAMPUS, CITY, COUNTRY, DIVISION, EDUCATION_MODE, FELLOWSHIP_STATUS, JOB_NATURE, PATENT_STATUS, POSITION, REGION, STATE, WRITTENT } from '@/model/Api';
...
const ResearchProjectPositionsScreen = () => {
                        ...
                        <h2 my={20} className='underline my-5 text-xl font-semibold underline-offset-8 text-red-500'>
                            ...
                            <Card my={20} radius="sm" shadow='xs' className={active == 12 ? 'h-[calc(100%_-_1.25rem)] flex items-center justify-center' : ''}>
                                <Card.Section p={0}>
                                    ...
                                    {/* Exprience In */}
                                    {
                                        active == 4 && <ExprienceInComponent hasAcademic={true} 
                                    ...
                                    {/* Patent Details */}
                                    {
                                        active == 8 && <PatentDetailsComponent md_patent={md_patent} form={form} />
                                    }
                                    {/* End */}
...
export default ResearchProjectPositionsScreen
